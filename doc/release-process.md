...
**Perform Mac build:**
  ...
  OSX binaries are created by Gavin Andresen on a 32-bit, OSX 10.6 machine.
	...
	python2.7 contrib/macdeploy/macdeployqtplus Patacoin-Qt.app -add-qt-tr $T -dmg -fancy contrib/macdeploy/fancy.plist

 Build output expected: Patacoin-Qt.dmg

###Next steps:

* Code-sign Windows -setup.exe (in a Windows virtual machine) and
  OSX Patacoin-Qt.app (Note: only Gavin has the code-signing keys currently)
...
- Announce the release:
  ...
  - Patacoin-development mailing list

  - Optionally reddit /r/Patacoin, ...
