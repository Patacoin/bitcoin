...
{
    CPatacoinAddress addressParsed(address.toStdString());
...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered patacoin address / amount:
            ...
            scriptPubKey.SetDestination(CPatacoinAddress(rcp.address.toStdString()).Get());
...
{
    QString strAddress = QString::fromStdString(CPatacoinAddress(address).ToString());
...
void WalletModel::listCoins(std::map<QString, std::vector<COutput> >& mapCoins) const
{
    ...
    BOOST_FOREACH(const COutput& out, vCoins)
    {
        ...
        mapCoins[CPatacoinAddress(address).ToString().c_str()].push_back(out);
    }
}
