...
#ifndef _PATACOINRPC_CLIENT_H_
#define _PATACOINRPC_CLIENT_H_ 1
...
/** Show help message for patacoin-cli.
 ...
 *
 * @note the argument can be removed once patacoin-cli functionality is removed from patacoind
 */
