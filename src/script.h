...
#ifndef H_PATACOIN_SCRIPT
#define H_PATACOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPatacoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Patacoin always counted CHECKMULTISIGs
