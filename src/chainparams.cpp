...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("patacoin.sipa.be", "seed.patacoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.patacoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("patacoinstats.com", "seed.patacoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("patacoin.petertodd.org", "testnet-seed.patacoin.petertodd.org"));
